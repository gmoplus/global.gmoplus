...
define('RL_REDIS_USER', '{REDIS_USER}');
define('RL_REDIS_PASS', '{REDIS_PASSWORD}');
define('RL_REDIS_HOST', '{REDIS_HOST}');
define('RL_REDIS_PORT', {REDIS_PORT});
