...
<div class="content-padding">
    ...
    {else}
        {if $news}
            ...
            <!-- paging block -->
            {if !$showAllMode}
                {* Normal pagination - "Hepsini Göster" modunda gizle *}
            ...
            {else}
                {* "Hepsini Göster" modu - pagination yok, sadık bilgi *}
                <div class="text-center text-muted">
                    <p><i class="fa fa-info-circle"></i> {$pageInfo.calc} blog gösteriliyor (Hepsi)</p>
                    <a href="{pageUrl key='news'}" class="btn btn-outline-secondary btn-sm">
                        <i class="fa fa-arrow-left"></i> Normal Görünüme Dön
                    </a>
                </div>
            {/if}
            <!-- paging block end -->
