...
{if $quote}
    ...
    <div class="quote-detail">
        <div class="content-area">
            ...
            <div class="back-link">
                <a href="{$rlBase}my-quotes.html" class="btn btn-secondary">← Tekliflere Dön</a>
            </div>
        </div>
    </div>
            ...
            {if $quotes}
                ...
                <div class="pagination">
                    {for $i=1 to $pages_count}
                        ...
                        {else}
                            <a href="{$rlBase}my-quotes.html?pg={$i}{if $selected_listing}&listing_id={$selected_listing}{/if}{if $selected_status}&status={$selected_status}{/if}">{$i}</a>
                        {/if}
                    {/for}
                </div>
                {/if}
